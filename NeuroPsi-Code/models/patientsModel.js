...
module.exports.getTests = async function(id_patient) {
    try {
        const sql = 'SELECT ID_Test_Patient, Date_Test_Patient, type_Test FROM Test_Patient, Test_Type WHERE ID_Patient = ? and state_Test_Patient = 2 AND Test_Type = ID_Test_Type'
